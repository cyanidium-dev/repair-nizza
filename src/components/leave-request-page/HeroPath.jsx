    ...
    <Container>
      <div className="pt-[30px] pb-[94px] lg:pt-[71px] lg:pb-[70px]">
        ...
        <Image
          ...
          className="absolute top-[175px] left-0 -z-20 lg:hidden"
        />
        <Image
          src={motifDesk1}
          alt="leave-motif-mob-1"
        ...
        <Image
          src={shadowMob}
          alt="leave-motif-mob-1"
          className="absolute top-[45px] right-[5px] -z-10 opacity-30 lg:hidden"
        />
        <Image
          src={shadowMob}
          alt="leave-motif-mob-1"
          className="absolute top-[45px] left-[5px] -z-10 opacity-30 lg:hidden"
        />
        <Image
          src={shadowDesk}
          alt="leave-motif-mob-1"
        ...
        <Image
          src={shadowDesk}
          alt="leave-motif-mob-1"
          className="absolute top-[-245px] left-[-90px] opacity-50 -z-10 hidden lg:block"
        />
        <Image
          src={motifMob2}
          alt="leave-motif-mob-1"
          className="absolute top-[230px] right-0 -z-20 lg:hidden"
        />
        <Image
          src={motifDesk2}
          alt="leave-motif-mob-1"
          className="absolute bottom-[75px] right-0 -z-20 hidden lg:block"
        />
        <div>
