  ...
  return (
    <>
      ...
      <div
        ...
        className="bg-cover bg-center h-[896px] lg:h-[755px] w-full hidden md:block"
      >
        <Container>
          <div className="pt-[72px] relative lg:pt-[75px]">
            <div className="md:flex md:flex-col md:justify-center md:items-center lg:justify-end lg:items-end">
              <h2 className="font-arsenal font-normal text-4xl text-primary-white uppercase mb-[18px] leading-[43px] lg:text-[82px] lg:leading-[98px] lg:mb-[18px]">
                {t("aboutUs.title")}
              </h2>
              <p className="font-montserrat font-normal text-sm text-primary-white mb-9 w-[295px] md:text-center lg:text-base lg:text-right lg:mb-10 lg:w-[575px]">
                {t("aboutUs.description")}
              </p>
              <button className="w-[310px] lg:w-[317px] h-[52px] rounded-[32px] lg:mx-0 lg:ml-auto bg-primary-white text-primary-black font-montserrat font-normal text-sm mx-auto leading-5 hover:bg-transparent hover:text-primary-white hover:border-primary-white border transition-all duration-300">
                {t("aboutUs.button")}
              </button>
            </div>
            <div className="absolute bottom-[-555px] lg:bottom-[-400px] left-0 w-[310px] lg:w-[359px] rounded-t-[20px] py-9 px-[22px] lg:pt-9 lg:px-9 lg:pb-[62px] backdrop-blur-[26px] shadow-[inset_0_4px_13px_0_rgba(255,255,255,0.25)] bg-[rgba(18,18,18,0.26)]">
